...
{
    /// <summary>
    /// FormLPositionActual entity model to map database FormLPositionActual table 
    /// </summary>
    public class FormLPositionActual : PersistentObjectWithUpdateAuditLogStatus<int>
    {
        public FormLPositionActual()
        {
        }
