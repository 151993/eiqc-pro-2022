...
namespace QSS.eIQC.Domain.Models
{
    ...
    /// </summary>
    public class SupplierFunctionVariable : PersistentObjectWithUpdate<int>
    {
        public SupplierFunctionVariable()
        {
            this.SupplierFunctionVariableActuals = new HashSet<SupplierFunctionVariableActual>();
        }
        ...
        public virtual ICollection<SupplierFunctionVariableActual> SupplierFunctionVariableActuals { get; set; }
