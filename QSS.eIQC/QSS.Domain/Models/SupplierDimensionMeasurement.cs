...
namespace QSS.eIQC.Domain.Models
{
    ...
    /// </summary>
    public class SupplierDimensionMeasurement : PersistentObjectWithUpdate<int>
    {
        public SupplierDimensionMeasurement()
        {
            this.SupplierDimensionMeasurementActuals = new HashSet<SupplierDimensionMeasurementActual>();
        }
        ...
        public virtual ICollection<SupplierDimensionMeasurementActual> SupplierDimensionMeasurementActuals { get; set; }
