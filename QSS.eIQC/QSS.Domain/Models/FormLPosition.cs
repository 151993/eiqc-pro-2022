...
{
    /// <summary>
    /// FormLPosition entity model to map database FormLPosition table 
    /// </summary>
    public class FormLPosition : PersistentObjectWithUpdateAuditLogStatus<int>
    {
        public FormLPosition()
        {
        }
