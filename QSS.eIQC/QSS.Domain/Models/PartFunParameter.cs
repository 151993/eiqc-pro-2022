...
{
    /// <summary>
    /// PartFunParameter entity model to map database PartFunParameter table 
    /// </summary>
    public class PartFunParameter : PersistentObjectWithUpdate<int>
    {
        public PartFunParameter()
        {
        }
