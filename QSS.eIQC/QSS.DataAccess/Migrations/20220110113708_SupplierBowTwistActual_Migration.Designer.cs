...
namespace QSS.eIQC.DataAccess.Migrations
{
    ...
    [Migration("20220110113708_SupplierBowTwistActual_Migration")]
    partial class SupplierBowTwistActual_Migration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.SupplierMeasurementManufacturePartNumber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("SMSManufacturePartNumberId")
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.Property<int>("PartInspectionManufacturePartNumberId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PartInspectionManufacturePartNumberId");

                    b.HasIndex("SupplierMeasurementSubmissionId");

                    b.ToTable("SupplierMeasurementManufacturePartNumber");
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.SupplierMeasurementManufacturePartNumber", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.PartInspectionManufacturePartNumber", "PartInspectionManufacturePartNumber")
                        .WithMany()
                        .HasForeignKey("PartInspectionManufacturePartNumberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QSS.eIQC.Domain.Models.SupplierMeasurementSubmission", "SupplierMeasurementSubmission")
                        .WithMany("SupplierMeasurementManufacturePartNumbers")
                        .HasForeignKey("SupplierMeasurementSubmissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
