...
namespace QSS.eIQC.DataAccess.Migrations
{
    ...
    [Migration("20210615074424_Parameter_PT_PC_code_Migration")]
    partial class Parameter_PT_PC_code_Migration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.EnumModels.ParameterManagementTypeModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 9,
                            Description = "M Position Tolerance",
                            IsEnabled = false,
                            Name = "MPositionTolerance"
                        },
                        new
                        {
                            Id = 10,
                            Description = "L Position Tolerance",
                            IsEnabled = false,
                            Name = "LPositionTolerance"
                        });
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.EnumModels.PermissionTypeModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 414,
                            Description = "Admin_MaterialGroupUser_Can_Access",
                            Name = "AdminMaterialGroupUserCanAccess"
                        },
                        new
                        {
                            Id = 415,
                            Description = "Admin_MaterialGroupUser_Can_Create",
                            Name = "AdminMaterialGroupUserCanCreate"
                        },
                        new
                        {
                            Id = 416,
                            Description = "Admin_MaterialGroupUser_Can_Update",
                            Name = "AdminMaterialGroupUserCanUpdate"
                        },
                        new
                        {
                            Id = 417,
                            Description = "Admin_MaterialGroupUser_Can_Delete",
                            Name = "AdminMaterialGroupUserCanDelete"
                        },
                        new
                        {
                            Id = 418,
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.DateCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DateCodeId")
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.MaterialGroupDccUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("MaterialGroupDccUserId")
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.Property<int>("MaterialGroupUserId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MaterialGroupUserId");

                    b.HasIndex("UserId");

                    b.ToTable("MaterialGroupDccUser");
                });

            modelBuilder.Entity("QSS.eIQC.Domain.Models.MaterialGroupJabilUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("MaterialGroupJabilUserId")
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.ToTable("MaterialGroupJabilUser");
                });

            modelBuilder.Entity("QSS.eIQC.Domain.Models.MaterialGroupUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("MaterialGroupUserId")
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.PartBowTwistParameter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("PartBowTwistParameter");
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.SAPPartInspectionPlan", b =>
                {
                    ...
                    b.Property<string>("ManufacturerRevisionPartNumber")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.MaterialGroupDccUser", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.MaterialGroupUser", "MaterialGroupUser")
                        .WithMany("MaterialGroupDccUsers")
                        .HasForeignKey("MaterialGroupUserId")
                        .HasConstraintName("FK_MaterialGroupDccUser_MaterialGroupUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.User", "User")
                        ...
                        .HasConstraintName("FK_MaterialGroupDccUser_UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.MaterialGroupJabilUser", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.MaterialGroupUser", "MaterialGroupUser")
                        .WithMany("MaterialGroupJabilUsers")
                        .HasForeignKey("MaterialGroupUserId")
                        .HasConstraintName("FK_MaterialGroupJabilUser_MaterialGroupUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.User", "User")
                        .WithMany("MaterialGroupJabilUsers")
                        .HasForeignKey("UserId")
                        .HasConstraintName("FK_MaterialGroupJabilUser_UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.MaterialGroupUser", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.MaterialGroup", "MaterialGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.PartBowTwistParameter", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.Part", "Part")
                        .WithMany("PartBowTwistParameter")
                        .HasForeignKey("PartNo")
                        .HasConstraintName("FK_PartBowTwistParameter_PartNo")
                        .HasPrincipalKey("PartNo")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.PartCountParameter", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.Part", "Part")
                        .WithMany("PartCountParameter")
                        .HasForeignKey("PartNo")
                        .HasConstraintName("FK_PartCountParameter_PartNo")
                        .HasPrincipalKey("PartNo")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.PartDateCode", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.Part", "Part")
                        .WithMany("PartDateCode")
                        .HasForeignKey("PartNo")
                        .HasConstraintName("FK_PartDateCode_PartNo")
                        .HasPrincipalKey("PartNo")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.PartFunParameter", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.Part", "Part")
                        .WithMany("PartFunParameter")
                        .HasForeignKey("PartNo")
                        .HasConstraintName("FK_PartFunParameter_PartNo")
                        .HasPrincipalKey("PartNo")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.PartInspectionDrawingAttachment", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.SAPPartInspectionPlan", "SAPPartInspectionPlan")
                        ...
                        .HasConstraintName("FK_SAPPartInspectionPlan_SAPPartInspectionPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.PartInspectionSpecAttachment", b =>
                {
                    b.HasOne("QSS.eIQC.Domain.Models.Attachment", "Attachment")
                        .WithMany("PartInspectionUploadSpecAttachments")
                        .HasForeignKey("AttachmentId")
                        .HasConstraintName("FK_Attachment_AttachmentId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.PartLPositionTolerance", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.Part", "Part")
                        .WithMany("PartLPositionTolerance")
                        .HasForeignKey("PartNo")
                        .HasConstraintName("FK_PartLPositionTolerance_PartNo")
                        .HasPrincipalKey("PartNo")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.PartMPositionTolerance", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.Part", "Part")
                        .WithMany("PartMPositionTolerance")
                        .HasForeignKey("PartNo")
                        .HasConstraintName("FK_PartMPositionTolerance_PartNo")
                        .HasPrincipalKey("PartNo")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.PartMeasurementParameter", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.Part", "Part")
                        .WithMany("PartMeasurementParameter")
                        .HasForeignKey("PartNo")
                        .HasConstraintName("FK_PartMeasurementParameter_PartNo")
                        .HasPrincipalKey("PartNo")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.PartMicrosection", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.Part", "Part")
                        .WithMany("PartMicrosection")
                        .HasForeignKey("PartNo")
                        .HasConstraintName("FK_PartMicrosection_PartNo")
                        .HasPrincipalKey("PartNo")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.PartResultOrientedParameter", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.Part", "Part")
                        .WithMany("PartResultOrientedParameter")
                        .HasForeignKey("PartNo")
                        .HasConstraintName("FK_PartResultOrientedParameter_PartNo")
                        .HasPrincipalKey("PartNo")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.PartTestReportParameter", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.Part", "Part")
                        .WithMany("PartTestReportParameter")
                        .HasForeignKey("PartNo")
                        .HasConstraintName("FK_PartTestReportParameter_PartNo")
                        .HasPrincipalKey("PartNo")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.SiteDepartment", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.Department", "Department")
                        .WithMany("SiteDepartments")
                        .HasForeignKey("DepartmentId")
                        .HasConstraintName("FK_SiteDepartment_DepartmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.Site", "Site")
                        .WithMany("SiteDepartments")
                        .HasForeignKey("SiteId")
                        .HasConstraintName("FK_SiteDepartment_SiteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("QSS.eIQC.Domain.Models.SiteWorkCell", b =>
                {
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.Site", "Site")
                        .WithMany("SiteWorkCells")
                        .HasForeignKey("SiteId")
                        .HasConstraintName("FK_SiteWorkCell_SiteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("QSS.eIQC.Domain.Models.WorkCell", "WorkCell")
                        .WithMany("SiteWorkCells")
                        .HasForeignKey("WorkCellId")
                        .HasConstraintName("FK_SiteWorkCell_WorkCellId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
