...
{
    /// <summary>
    /// Representation model for Add SupplierMeasurementSubmission operation
    /// </summary>
    public class AddSupplierMeasurementSubmissionModel : BaseCommand, IRequest<SupplierMeasurementSubmissionModel>
    {
