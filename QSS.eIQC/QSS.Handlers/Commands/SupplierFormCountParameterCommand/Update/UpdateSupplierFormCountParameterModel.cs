...
{
    /// <summary>
    /// Representation model for Update SupplierFormCountParameter operation
    /// </summary>
    public class UpdateSupplierFormCountParameterModel : BaseUpdateCommand<int>, IRequest<SupplierFormCountParameterModel>
    {
