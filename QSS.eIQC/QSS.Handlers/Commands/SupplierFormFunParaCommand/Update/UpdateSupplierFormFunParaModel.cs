...
{
    /// <summary>
    /// Representation model for Update SupplierFormFunPara operation
    /// </summary>
    public class UpdateSupplierFormFunParaModel : BaseUpdateCommand<int>, IRequest<SupplierFormFunParaModel>
    {
