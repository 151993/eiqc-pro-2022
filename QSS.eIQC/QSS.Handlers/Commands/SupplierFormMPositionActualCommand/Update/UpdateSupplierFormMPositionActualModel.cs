...
{
    /// <summary>
    /// Representation model for Update SupplierFormMPositionActual operation
    /// </summary>
    public class UpdateSupplierFormMPositionActualModel : BaseUpdateCommand<int>, IRequest<SupplierFormMPositionActualModel>
    {
