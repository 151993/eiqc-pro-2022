...
namespace QSS.eIQC.Handlers.Commands.PartInspectionDrawingAttachmentCommand
{
	...
	public class MappingProfile : Profile
	{
		...
		public MappingProfile()
		{
			...
			CreateMap<AddPartInspectionDrawingAttachmentModel, PartInspectionDrawingAttachment>()
				.ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.IsEnabled ? StatusType.Active : StatusType.Inactive));

			CreateMap<UpdatePartInspectionDrawingAttachmentModel, PartInspectionDrawingAttachment>()
				.ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.IsEnabled ? StatusType.Active : StatusType.Inactive));
