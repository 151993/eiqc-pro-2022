...
{
    /// <summary>
    /// Representation model for Update ReceiveGoodsInfo operation
    /// </summary>
    public class UpdateReceiveGoodsInfoModel : BaseUpdateCommand<int>, IRequest<ReceiveGoodsInfoModel>
    {
        /// <summary>
