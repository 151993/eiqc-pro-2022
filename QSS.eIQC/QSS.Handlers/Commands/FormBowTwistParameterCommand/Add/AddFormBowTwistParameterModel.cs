...
{
    /// <summary>
    /// Representation model for Add FormBowTwistParameter operation
    /// </summary>
    public class AddFormBowTwistParameterModel : BaseCommand, IRequest<FormBowTwistParameterModel>
    {
