...
{
    /// <summary>
    /// Representation model for Update SupplierFormFunParaActual operation
    /// </summary>
    public class UpdateSupplierFormFunParaActualModel : BaseUpdateCommand<int>, IRequest<SupplierFormFunParaActualModel>
    {
