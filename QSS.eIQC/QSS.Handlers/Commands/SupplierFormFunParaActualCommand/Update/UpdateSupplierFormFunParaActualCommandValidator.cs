...
namespace QSS.eIQC.Handlers.Commands.SupplierFormFunParaActualCommand.Update
{
    ...
    /// </summary>
    public class UpdateSupplierFormFunParaActualCommandValidator : AbstractValidator<UpdateSupplierFormFunParaActualModel>
    {
        /// <summary>
        /// Contains validation logic
        /// </summary>
        public UpdateSupplierFormFunParaActualCommandValidator()
        {
