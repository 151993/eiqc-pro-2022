...
namespace QSS.eIQC.Handlers.Commands.SupplierFormFunParaActualCommand
{
    public class MappingProfile : Profile
    {
        ...
        {
            CreateMap<SupplierFormFunParaActual, SupplierFormFunParaActualModel>()
            ...
            CreateMap<AddSupplierFormFunParaActualModel, SupplierFormFunParaActual>()
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.IsEnabled ? StatusType.Active : StatusType.Inactive));

            CreateMap<UpdateSupplierFormFunParaActualModel, SupplierFormFunParaActual>()
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.IsEnabled ? StatusType.Active : StatusType.Inactive));
