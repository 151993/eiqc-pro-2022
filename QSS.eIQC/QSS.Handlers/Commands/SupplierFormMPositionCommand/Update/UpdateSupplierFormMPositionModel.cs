...
{
    /// <summary>
    /// Representation model for Update SupplierFormMPosition operation
    /// </summary>
    public class UpdateSupplierFormMPositionModel : BaseUpdateCommand<int>, IRequest<SupplierFormMPositionModel>
    {
