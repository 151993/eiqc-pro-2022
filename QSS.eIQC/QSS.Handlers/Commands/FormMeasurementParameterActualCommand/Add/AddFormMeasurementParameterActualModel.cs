...
{
    /// <summary>
    /// Representation model for Add FormMeasurementParameterActual operation
    /// </summary>
    public class AddFormMeasurementParameterActualModel : BaseCommand, IRequest<FormMeasurementParameterActualModel>
    {
