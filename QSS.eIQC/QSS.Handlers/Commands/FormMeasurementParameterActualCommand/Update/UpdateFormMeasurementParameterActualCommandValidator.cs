...
namespace QSS.eIQC.Handlers.Commands.FormMeasurementParameterActualCommand.Update
{
    ...
    /// </summary>
    public class UpdateFormMeasurementParameterActualCommandValidator : AbstractValidator<UpdateFormMeasurementParameterActualModel>
    {
        /// <summary>
        /// Contains validation logic
        /// </summary>
        public UpdateFormMeasurementParameterActualCommandValidator()
        {
