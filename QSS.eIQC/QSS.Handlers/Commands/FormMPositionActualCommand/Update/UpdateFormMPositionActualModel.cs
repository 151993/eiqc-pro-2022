...
{
    /// <summary>
    /// Representation model for Update FormMPositionActual operation
    /// </summary>
    public class UpdateFormMPositionActualModel : BaseUpdateCommand<int>, IRequest<FormMPositionActualModel>
    {
