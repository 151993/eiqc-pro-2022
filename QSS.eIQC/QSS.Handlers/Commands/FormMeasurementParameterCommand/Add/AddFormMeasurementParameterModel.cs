...
{
    /// <summary>
    /// Representation model for Add FormMeasurementParameter operation
    /// </summary>
    public class AddFormMeasurementParameterModel : BaseCommand, IRequest<FormMeasurementParameterModel>
    {
