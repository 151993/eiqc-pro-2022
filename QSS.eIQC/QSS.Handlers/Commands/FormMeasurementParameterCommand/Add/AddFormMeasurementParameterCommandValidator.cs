...
namespace QSS.eIQC.Handlers.Commands.FormMeasurementParameterCommand.Add
{
    ...
    /// </summary>
    public class AddFormMeasurementParameterCommandValidator : AbstractValidator<AddFormMeasurementParameterModel>
    {
        /// <summary>
        /// Contains validation logic
        /// </summary>
        public AddFormMeasurementParameterCommandValidator()
        {
