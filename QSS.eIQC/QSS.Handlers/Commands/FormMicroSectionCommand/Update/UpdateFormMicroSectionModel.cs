...
{
    /// <summary>
    /// Representation model for Update FormMicroSection operation
    /// </summary>
    public class UpdateFormMicroSectionModel : BaseUpdateCommand<int>, IRequest<FormMicroSectionModel>
    {
