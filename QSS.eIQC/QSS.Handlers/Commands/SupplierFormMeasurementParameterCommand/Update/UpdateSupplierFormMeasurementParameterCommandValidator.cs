...
namespace QSS.eIQC.Handlers.Commands.SupplierFormMeasurementParameterCommand.Update
{
    ...
    /// </summary>
    public class UpdateSupplierFormMeasurementParameterCommandValidator : AbstractValidator<UpdateSupplierFormMeasurementParameterModel>
    {
        /// <summary>
        /// Contains validation logic
        /// </summary>
        public UpdateSupplierFormMeasurementParameterCommandValidator()
        {
