...
namespace QSS.eIQC.Handlers.Commands.SupplierFormMeasurementParameterCommand.Add
{
    ...
    /// </summary>
    public class AddSupplierFormMeasurementParameterCommandValidator : AbstractValidator<AddSupplierFormMeasurementParameterModel>
    {
        /// <summary>
        /// Contains validation logic
        /// </summary>
        public AddSupplierFormMeasurementParameterCommandValidator()
        {
