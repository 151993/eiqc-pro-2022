...
namespace QSS.eIQC.Handlers.Commands.SupplierFormBowTwistParameterCommand.Update
{
    ...
    /// </summary>
    public class UpdateSupplierFormBowTwistParameterCommandValidator : AbstractValidator<UpdateSupplierFormBowTwistParameterModel>
    {
        /// <summary>
        /// Contains validation logic
        /// </summary>
        public UpdateSupplierFormBowTwistParameterCommandValidator()
        {
