...
namespace QSS.eIQC.Handlers.Commands.SupplierFormMicroSectionActualCommand.Update
{
    ...
    /// </summary>
    public class UpdateSupplierFormMicroSectionActualCommandValidator : AbstractValidator<UpdateSupplierFormMicroSectionActualModel>
    {
        /// <summary>
        /// Contains validation logic
        /// </summary>
        public UpdateSupplierFormMicroSectionActualCommandValidator()
        {
