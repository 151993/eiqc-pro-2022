...
namespace QSS.eIQC.Handlers.Commands.SupplierFormMicroSectionActualCommand.Add
{
    ...
    /// </summary>
    public class AddSupplierFormMicroSectionActualCommandValidator : AbstractValidator<AddSupplierFormMicroSectionActualModel>
    {
        /// <summary>
        /// Contains validation logic
        /// </summary>
        public AddSupplierFormMicroSectionActualCommandValidator()
        {
