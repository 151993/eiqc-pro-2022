...
namespace QSS.eIQC.Handlers.Commands.FormLPositionActualCommand.Update
{
    ...
    /// </summary>
    public class UpdateFormLPositionActualCommandValidator : AbstractValidator<UpdateFormLPositionActualModel>
    {
        /// <summary>
        /// Contains validation logic
        /// </summary>
        public UpdateFormLPositionActualCommandValidator()
        {
