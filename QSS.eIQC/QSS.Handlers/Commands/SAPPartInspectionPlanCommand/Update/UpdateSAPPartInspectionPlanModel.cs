...
namespace QSS.eIQC.Handlers.Commands.SAPPartInspectionPlanCommand.Update
{
    ...
    /// </summary>
    public class UpdateSAPPartInspectionPlanModel : BaseUpdateCommand<int>, IRequest<SAPPartInspectionPlanModel>
    {
        ...
        public List<int> RemovedAdminCertificateIds { get; set; }

        public List<int> RemovedCertificationAttachmentIds { get; set; }

        public List<int> RemovedDrawingIds { get; set; }

        public List<int> RemovedSpecIds { get; set; }
        ...
        public IEnumerable<PartInspectionCertificationAttachmentModel> PartInspectionCertificationAttachments { get; set; }
