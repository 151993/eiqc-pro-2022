...
namespace QSS.eIQC.Handlers.Commands.ReceiveGoodsInfoManualCommand.Add
{
    ...
    /// </summary>
    public class AddReceiveGoodsInfoManualCommandValidator : AbstractValidator<AddReceiveGoodsInfoManualModel>
    {
        /// <summary>
        /// Contains validation logic
        /// </summary>
        public AddReceiveGoodsInfoManualCommandValidator()
        {
