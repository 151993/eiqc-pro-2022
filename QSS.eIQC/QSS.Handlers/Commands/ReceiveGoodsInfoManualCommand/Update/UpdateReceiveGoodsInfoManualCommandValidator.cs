...
namespace QSS.eIQC.Handlers.Commands.ReceiveGoodsInfoManualCommand.Update
{
    ...
    /// </summary>
    public class UpdateReceiveGoodsInfoManualCommandValidator : AbstractValidator<UpdateReceiveGoodsInfoManualModel>
    {
        /// <summary>
        /// Contains validation logic
        /// </summary>
        public UpdateReceiveGoodsInfoManualCommandValidator()
        {
