...
namespace QSS.eIQC.Handlers.Commands.SupplierFormMicroSectionCommand.Update
{
    ...
    /// </summary>
    public class UpdateSupplierFormMicroSectionCommandValidator : AbstractValidator<UpdateSupplierFormMicroSectionModel>
    {
        /// <summary>
        /// Contains validation logic
        /// </summary>
        public UpdateSupplierFormMicroSectionCommandValidator()
        {
