...
namespace QSS.eIQC.Handlers.Commands.SupplierFormSpecialParameterCommand
{
    public class MappingProfile : Profile
    {
        ...
        {
            CreateMap<SupplierFormSpecialParameter, SupplierFormSpecialParameterModel>()
            ...
            CreateMap<AddSupplierFormSpecialParameterModel, SupplierFormSpecialParameter>()
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.IsEnabled ? StatusType.Active : StatusType.Inactive));

            CreateMap<UpdateSupplierFormSpecialParameterModel, SupplierFormSpecialParameter>()
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.IsEnabled ? StatusType.Active : StatusType.Inactive));
